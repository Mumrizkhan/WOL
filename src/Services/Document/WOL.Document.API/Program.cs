...
using WOL.Document.Infrastructure.Repositories;
using WOL.Document.Infrastructure;
...
builder.Services.AddMediatR(cfg => 
    cfg.RegisterServicesFromAssembly(typeof(WOL.Document.Application.Commands.UploadDocumentCommand).Assembly));
