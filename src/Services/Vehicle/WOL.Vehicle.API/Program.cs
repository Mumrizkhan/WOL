...
using WOL.Vehicle.Infrastructure.Repositories;
using WOL.Vehicle.Infrastructure;
...
builder.Services.AddMediatR(cfg => 
    cfg.RegisterServicesFromAssembly(typeof(WOL.Vehicle.Application.Commands.RegisterVehicleCommand).Assembly));
