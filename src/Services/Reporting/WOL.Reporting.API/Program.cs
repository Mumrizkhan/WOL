...
using WOL.Reporting.Infrastructure.Repositories;
using WOL.Reporting.Infrastructure;
...
builder.Services.AddMediatR(cfg => 
    cfg.RegisterServicesFromAssembly(typeof(WOL.Reporting.Application.Commands.GenerateReportCommand).Assembly));
