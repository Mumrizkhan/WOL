...
using WOL.Notification.Infrastructure.Repositories;
using WOL.Notification.Infrastructure;
...
builder.Services.AddMediatR(cfg => 
    cfg.RegisterServicesFromAssembly(typeof(WOL.Notification.Application.Commands.SendNotificationCommand).Assembly));
