...
using WOL.Analytics.Infrastructure.Repositories;
using WOL.Analytics.Infrastructure;
...
builder.Services.AddMediatR(cfg => 
    cfg.RegisterServicesFromAssembly(typeof(WOL.Analytics.Application.Commands.TrackEventCommand).Assembly));
